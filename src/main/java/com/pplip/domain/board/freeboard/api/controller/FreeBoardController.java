...
public class FreeBoardController implements FreeBoardDocsController {
	...
	@PostMapping("/{id}/like")
	public CommonResponse<FreeBoardResponse.Like> likeFreeBoard(
			@PathVariable Long id,
			@AuthenticationPrincipal
			UserDetails principal) {
		FreeBoardResponse.Like like = freeBoardService.like(id, principal);
		return CommonResponse.success(like.getAction().equals("NEW") ? SuccessCode.CREATED : SuccessCode.REMOVED, like);
	}
}
